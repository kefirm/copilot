  ...
  return (
    <div className="space-y-4">
      ...
      <form action={updatePlant} className="grid gap-3 rounded-lg border border-zinc-200 bg-white p-4 md:grid-cols-2">
        ...
        <label className="flex flex-col gap-1">
          Wiersz (1-200)
          <input type="number" min={1} max={200} name="row_num" defaultValue={plant.row_num} required />
        </label>
        <label className="flex flex-col gap-1">
          Kolumna (1-20)
          <input type="number" min={1} max={20} name="col_num" defaultValue={plant.col_num} required />
        </label>
